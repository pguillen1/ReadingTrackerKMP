...
fun AddEditReadingSessionScreen(
	...
	Scaffold(
		...
		Column(
			...
			SessionDatePickerField(
				modifier = Modifier.testTag(AddEditSession.DATE_FIELD),
				date = uiState.date,
...
fun SessionDatePickerDialog(
	...
	@OptIn(ExperimentalMaterial3Api::class)
	DatePickerDialog(
		modifier = Modifier.testTag(AddEditSession.DATE_DIALOG),
