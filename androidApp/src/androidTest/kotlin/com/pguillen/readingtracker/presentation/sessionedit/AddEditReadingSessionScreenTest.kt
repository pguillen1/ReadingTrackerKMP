...
class AddEditReadingSessionScreenTest {
    ...
    @Test
    fun clickingDatePickerFieldShowsDatePickerDialog() {
        setContent()

        composeRule.onNodeWithTag(ReadingTrackerTestTags.AddEditSession.DATE_FIELD)
            .performClick()

        composeRule.onNodeWithTag(ReadingTrackerTestTags.AddEditSession.DATE_DIALOG)
            .assertIsDisplayed()
    }
